...
class ActionReload(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        # for the sake of simplicity, these values aren't validated.
        ...
        # Scenarios are simply simulated here as I don't want to focus on backend
    ...
    def success_or_failure() -> bool:
        ...
        in real scenario, the success or failure depends on backend systems.
        I have used randomization to emulate that behaviour so all scenarios can be tested
        """
    ...
    def check_amount(amount: float) -> int:
        ...
        this is because people add extra zeroes by mistake
        """
